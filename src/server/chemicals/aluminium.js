...
export const addAluminiumProcessingRecipes = (event) => {
    ...
    event.recipes.gtceu.chemical_reactor("nijika:tier02/aluminium/bayer_pt_1")
        .itemInputs(
            "2x #forge:dusts/bauxite",
            "2x #forge:dusts/sodium_hydroxide"
        )
    ...
    event.recipes.gtceu.autoclave("nijika:tier02/aluminium/bayer_pt_2")
        .inputFluids(
            Fluid.of("gtceu:sodium_aluminate").withAmount(1 * FluidAmounts.BUCKET)
        )
        .itemOutputs(
            "1x gtceu:aluminium_hydroxide_dust",
    ...
    event.recipes.gtceu.electric_blast_furnace("nijika:tier02/aluminium/bayer_pt_3")
    ...
    // Step 4: Al2O3 -> 2Al + 3O
    event.recipes.gtceu.electrolyzer("nijika:tier02/aluminium/not_hall_heroult")
    ...
    event.recipes.gtceu.evaporation_pool("nijika:tier02/aluminium/red_mud_dust")
    ...
    event.recipes.gtceu.chemical_bath("nijika:tier02/aluminium/red_mud_slurry")
    ...
    event.recipes.gtceu.centrifuge("nijika:tier02/aluminium/red_mud_centrifuging")
        ...
        .outputFluids(Fluid.of("gtceu:diluted_hydrochloric_acid").withAmount(1 * FluidAmounts.BUCKET))
        .EUt(GTValues.VA[GTValues.MV])
        .duration(20);
}
