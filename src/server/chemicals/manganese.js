...
export const addManganeseProcessingRecipes = (event) => {
    ...
    event.recipes.gtceu.electric_blast_furnace("nijika:chemicals/manganese/pyrolusite_reduction_carbon")
        .itemInputs(
            "2x gtceu:pyrolusite_dust",
            "3x #nijika:carbon_rich_dusts",
        )
    ...
    event.recipes.gtceu.electric_blast_furnace("nijika:chemicals/manganese/pyrolusite_reduction_alumina")
        .itemInputs(
    ...
    event.recipes.gtceu.electric_blast_furnace("nijika:chemicals/manganese/ferromanganese_aluminium")
        .itemInputs(
            "gtceu:pyrolusite_dust",
            "4x gtceu:iron_dust",
            "2x gtceu:aluminium_dust"
    ...
    event.recipes.gtceu.electric_blast_furnace("nijika:chemicals/manganese/ferromanganese_from_fe2o3")
        .itemInputs(
