...
export const addMiscIronRecipes = (event) => {
    ...
    event.recipes.gtceu.electric_blast_furnace("nijika:chemicals/iron/magnetite_reduction")
    ...
    event.recipes.gtceu.electric_blast_furnace("nijika:chemicals/iron/magnetite_aluminothermic")
        .itemInputs(
            "8x gtceu:aluminium_dust",
            "3x gtceu:magnetite_dust"
        )
        .itemOutputs(
            "4x gtceu:alumina_dust",
            "9x gtceu:iron_dust",
        )
        .EUt(GTValues.VH[GTValues.MV])
        .duration(5 * 20)
    ...
    event.recipes.gtceu.electric_blast_furnace("nijika:chemicals/iron/hematite_reduction")
        .itemInputs(
    ...
    event.recipes.gtceu.electric_blast_furnace("nijika:chemicals/iron/iron_oxide_reduction")
        .itemInputs(
