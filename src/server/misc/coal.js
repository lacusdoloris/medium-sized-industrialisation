...
export const unfuckCoalRecipes = (event) => {
    ...
    event.recipes.gtceu.compressor("gtceu:compress_coal_gem_to_block")
        .itemInputs("9x #nijika:actually_fucking_coal")
        .itemOutputs("1x minecraft:coal_block")
        .duration(15 * 20)
        .EUt(2);

    event.recipes.gtceu.coke_oven("gtceu:coal_to_coke")
    ...
    event.replaceInput(
        ...
        "#forge:gems/coal", "#nijika:actually_fucking_coal"
    );

    event.recipes.gtceu.macerator("gtceu:macerate_coal")
        .itemInputs("1x #nijika:actually_fucking_coal")
