...
export const addMobRecipes = (event) => {
    ...
    for (let [idx, mob] of Object.keys(MOB_TYPES).entries()) {
        ...
        event.recipes.gtceu.autoclave(`nijika:misc/mobs/${mob}_autoclave_egg`)
...
export const addMobFarmRelatedRecipes = (event) => {
    ...
    event.recipes.gtceu.chemical_reactor("nijika:misc/mobs/blood_from_blackstone")
        .itemInputs(
            "8x minecraft:blackstone",
            "2x #forge:dusts/iron",
        )
