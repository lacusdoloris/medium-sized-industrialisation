...
export const addSlagProcessingRecipes = (event) => {
    ...
    event.recipes.gtceu
        ...
        .itemOutputs("24x gtceu:iron_dust", "8x gtceu:slag_dust")
    ...
    event.recipes.gtceu
        .chemical_bath("nijika:misc/slag_processing/slag_to_slurry")
        .itemInputs("2x gtceu:slag_dust")
    ...
    event.recipes.gtceu
        .centrifuge("nijika:misc/slag_processing/centrifuging_slurry")
