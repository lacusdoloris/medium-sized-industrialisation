...
export const redoGlassProcessing = (event) => {
    event.recipes.create
        .milling("gtceu:quartz_sand_dust", "#forge:sand/colorless")
        .id("nijika:glass/quartz_sand_dust");
    event.recipes.create
        .milling("gtceu:flint_dust", "#forge:gems/flint")
    ...
    event.recipes.create
        ...
        .heated()
        .id("nijika:glass/mix_molten_glass_from_glass_dust");

    // yeah... this doesn't really make sense.
    event.recipes.create
        .compacting("minecraft:glass", Fluid.of("gtceu:glass").withAmount(144 * FluidAmounts.MB))
