...
export const doTier00Content = (event) => {
    ...
    event.recipes.create.pressing(
        Item.of("gtceu:sticky_resin").withChance(0.5),
        "gtceu:rubber_log"
    ).id("nijika:tier00/merciful_sticky_resin_production");
    
    // no alloy smelter needed!
    event.recipes.create.mixing(
        Fluid.of("gtceu:rubber", 144 * FluidAmounts.MB),
    ...
    event.recipes.create.sequenced_assembly(
        ...
        [
            event.recipes.create.deploying(
                "gtceu:resin_circuit_board", ["gtceu:resin_circuit_board", "gtceu:copper_single_wire"]
            ),
            event.recipes.create.deploying(
                "gtceu:resin_circuit_board", ["gtceu:resin_circuit_board", "gtceu:copper_single_wire"]
            ),
    ...
    event.recipes.create.sequenced_assembly(
        ...
        [
            event.recipes.create.deploying(
                "minecraft:iron_ingot", ["minecraft:iron_ingot", "#forge:dusts/redstone"]
            ),
            event.recipes.create.deploying(
                "minecraft:iron_ingot", ["minecraft:iron_ingot", "#forge:dusts/redstone"]
            ),
    ...
    event.recipes.create.filling(
        "gtceu:glass_tube",
        ["#forge:ingots/clay", Fluid.of("gtceu:glass").withAmount(144 * FluidAmounts.MB)]
    ...
    event.shaped(
        "gtceu:vacuum_tube", 
        [" G ", "WWW"],
        {G: "gtceu:glass_tube", W: "gtceu:copper_single_wire"}
