...
export const addGalliumArsenicRecipes = (event) => {
    ...
    event.recipes.gtceu.electric_blast_furnace("nijika:tier01/arsenic/realgar_roasting")
        .itemInputs(
            "1x #forge:dusts/realgar"
        )
    ...
    event.recipes.gtceu.electric_blast_furnace("nijika:tier01/arsenic/orpiment_roasting")
    ...
    event.recipes.gtceu.chemical_reactor("nijika:tier01/arsenic/trichloride_production")
    ...
    event.recipes.gtceu.chemical_reactor("nijika:tier01/arsenic/gallium_arsenide")
