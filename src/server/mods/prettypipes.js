...
export const adjustPrettyPipesRecipes = (event) => {
    ...
    event.remove({id: /prettypipes:(?:low|medium|high)_(?:extraction|retrieval|crafting)_module/});
    event.replaceInput(
    ...
    event.shapeless(
        ...
        ["prettypipes:blank_module", "gtceu:lv_sensor"]
    ...
    event.shapeless(
        ...
        ["prettypipes:blank_module", "gtceu:lv_emitter"]
