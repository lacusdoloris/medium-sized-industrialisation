...
export const adjustIntegratedDynamicsRecipes = (event) => {
    ...
    event.recipes.gtceu.centrifuge("nijika:mods/id/menril_chunk")
        ...
        .outputFluids(Fluid.of("integrateddynamics:menril_resin").withAmount(1 * FluidAmounts.BUCKET))
        .EUt(GTValues.VHA[GTValues.LV])
        .duration(5 * 20);
    
    event.recipes.gtceu.autoclave("nijika:mods/id/menril_chunk_from_autoclave")
        .inputFluids(Fluid.of("integrateddynamics:menril_resin").withAmount(1 * FluidAmounts.BUCKET))
        .itemOutputs("9x integrateddynamics:crystalized_menril_chunk")
        .EUt(GTValues.VHA[GTValues.LV])
        .duration(10 * 20)
        .circuit(1);

    event.recipes.gtceu.autoclave("nijika:mods/id/menril_glass")
        .inputFluids(Fluid.of("integrateddynamics:menril_resin").withAmount(1 * FluidAmounts.BUCKET))
    ...
    event.recipes.gtceu.centrifuge("nijika:mods/id/chorus_chunks")
        ...
        .outputFluids(Fluid.of("integrateddynamics:liquid_chorus").withAmount(125 * FluidAmounts.MB))
        .EUt(GTValues.VHA[GTValues.LV])
        .duration(5 * 20);
    
    event.recipes.gtceu.autoclave("nijika:mods/id/chorus_chunk_from_autoclave")
        .inputFluids(Fluid.of("integrateddynamics:liquid_chorus").withAmount(1 * FluidAmounts.BUCKET))
        .itemOutputs("9x integrateddynamics:crystalized_chorus_chunk")
        .EUt(GTValues.VHA[GTValues.LV])
        .duration(10 * 20)
        .circuit(1);

    event.recipes.gtceu.centrifuge("nijika:mods/id/chorus_chunk_from_protochorus")
