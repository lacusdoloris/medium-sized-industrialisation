...
export const adjustModularRouterRecipes = (event) => {
    ...
    event.recipes.gtceu.assembler("nijika:mods/routers/blank_module")
        .itemInputs(
            "1x #gtceu:circuits/hv",
            "3x #forge:nuggets/gold",
        )
    ...
    event.recipes.gtceu.assembler("nijika:mods/routers/upgrade_module")
        .itemInputs(
            "1x #forge:gems/lapis",
            "3x #forge:nuggets/gold"
        )
    ...
    event.recipes.gtceu.assembler("nijika:mods/routers/modular_router")
        .itemInputs(
    ...
    event.shapeless(
        ...
        ["1x modularrouters:sender_module_2", "1x gtceu:quantum_eye"]
    ).id("nijika:mods/routers/sender_module_3");

    event.remove({id: "modularrouters:speed_upgrade"});
    event.recipes.gtceu.chemical_bath("nijika:mods/routers/really_stupid_speed_upgrade")
    ...
    event.shapeless(
        "1x modularrouters:bulk_item_filter",
        ["gtceu:item_filter", "modularrouters:blank_module"]
    ).id("nijika:mods/routers/bulk_item_filter");

    event.remove({id: "modularrouters:tag_filter"});
    event.shapeless(
        "1x modularrouters:tag_filter",
        ["modularrouters:bulk_item_filter", "minecraft:name_tag"]
    ).id("nijika:mods/routers/tag_filter");

    event.remove({id: "modularrouters:inspection_filter"});
    event.shapeless(
        "1x modularrouters:inspection_filter",
        ["modularrouters:bulk_item_filter", "minecraft:clock"]
    ...
    event.shapeless(
        ...
        ["1x modularrouters:augment_core", "#nijika:glues",]
    )
}
