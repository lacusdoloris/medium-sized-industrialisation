...
export const addSquaricAcidMaterials = (event) => {
    ...
    createAqueousIntermediate(event, "morpholine_hydrochloride", 0x566a6b).components(
        "4x gtceu:carbon", "10x gtceu:hydrogen", "1x gtceu:hydrogen", "1x gtceu:nitrogen",
        "1x gtceu:oxygen"
    );

    createAqueousIntermediate(event, "squaric_acid", 0x29e6e6);
    createDustIntermediate(event, "ammonium_squarate", 0x696b82);
    createDustIntermediate(event, "ammonium_nitrate", 0x333d45, true)
        .components("2x gtceu:nitrogen", "4x gtceu:hydrogen", "3x gtceu:oxygen");
}
...
export const addSquaricAcidRecipes = (event) => {
    ...
    event.recipes.gtceu
        ...
        .inputFluids(
            Fluid.of("gtceu:morpholine_hydrochloride").withAmount(1 * FluidAmounts.BUCKET)
        )
    ...
    event.recipes.gtceu
        ...
        .itemOutputs(
            "2x gtceu:ammonium_squarate_dust"
        )
        .EUt(GTValues.VA[GTValues.HV])
        .duration(20 * 20);
    ...
    event.recipes.gtceu
        ...
        .itemInputs(
            "20x gtceu:ammonium_squarate_dust",
            "20x gtceu:manganese_nitrate_dust"
        )
