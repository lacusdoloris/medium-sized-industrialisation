...
export const addTungstenMaterials = (event) => {
    ...
    createAcidicIntermediate(event, "pretreated_scheelite", 0x8fbdb7)
        .dust();
    ...
    createAqueousIntermediate(event, "impure_sodium_tungstate", 0xe6b48c)
        .components("2x gtceu:sodium", "1x gtceu:tungsten", "4x gtceu:oxygen");
};
...
export const addTungstenRecipes = (event) => {
    ...
    event.recipes.gtceu.chemical_reactor("nijika:chemicals/scheelitee/pre_treatment")
        .itemInputs("32x gtceu:crushed_scheelite_ore")
        .inputFluids(Fluid.of("gtceu:hydrochloric_acid").withAmount(12 * FluidAmounts.BUCKET))
        .outputFluids(
            Fluid.of("gtceu:pretreated_scheelite").withAmount(12 * FluidAmounts.BUCKET)
        )
        .chancedOutput("5x gtceu:small_arsenic_trioxide_dust", 4400.0, 74.00)
        .EUt(GTValues.VHA[GTValues.HV])
        .duration(20 * 20);

    event.recipes.gtceu.centrifuge("nijika:chemicals/scheelite/pre_treatment_separation")
        .inputFluids(Fluid.of("gtceu:pretreated_scheelite").withAmount(16 * FluidAmounts.BUCKET))
        .itemOutputs(
            "32x gtceu:pretreated_scheelite_dust",
        )
    ...
    event.recipes.gtceu.electric_blast_furnace("nijika:chemicals/scheelite/roasting")
    ...
    event.recipes.gtceu.chemical_reactor("nijika:chemicals/scheelite/digestion_naoh")
        .itemInputs(
            "32x gtceu:desulfurised_scheelite_dust",
            "64x gtceu:sodium_hydroxide_dust"
        )
    ...
    event.recipes.gtceu.chemical_reactor("nijika:chemicals/scheelite/digestion_na2co3")
        .itemInputs(
            "32x gtceu:desulfurised_scheelite_dust",
            "32x gtceu:soda_ash_dust",
        )
