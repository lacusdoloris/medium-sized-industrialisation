...
export const addTitaniumMaterials = (event) => {
    ...
    createAqueousIntermediate(event, "trichlorosilane", 0xddf0e7, true)
        .components("1x gtceu:hydrogen", "3x gtceu:chlorine", "1x gtceu:silicon");

    createAqueousIntermediate(event, "tin_iv_chloride", 0xc9f2df, true)
        .components("1x gtceu:tin", "4x gtceu:chlorine");
};
...
export const addTitaniumRecipes = (event) => {
    ...
    event.recipes.gtceu.chemical_reactor("nijika:chemicals/titanium/crude_ticl4")
        .itemInputs(
            "2x #nijika:carbon_rich_dusts",
            "1x #forge:dusts/rutile",
        )
    ...
    event.recipes.gtceu.distillation_tower("nijika:chemicals/titanium/semipure_ticl4")
        .inputFluids(Fluid.of("gtceu:impure_titanium_tetrachloride").withAmount(20 * FluidAmounts.BUCKET))
        .outputFluids(
            Fluid.of("gtceu:impure_titanium_tetrachloride_1").withAmount(18800 * FluidAmounts.MILLIBUCKET),
        )
        .chancedFluidOutput(
    ...
    // fuck OFF gtceu
    event.remove({ type: "gtceu:distillery", input: Fluid.of("gtceu:impure_titanium_tetrachloride") });
