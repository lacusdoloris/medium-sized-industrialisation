...
export const addBariumMaterials = (event) => {
    createDustIntermediate(event, "barium_oxide", 0x5f857f)
        .components("1x gtceu:barium", "1x gtceu:oxygen");
    createDustIntermediate(event, "barium_hydroxide", 0x5d706d)
        .components("1x gtceu:barium", "2x gtceu:oxygen", "2x gtceu:hydrogen");
};
...
export const addBariumRecipes = (event) => {
    ...
    // 4 C + BaSO4 = 4 CO + BaS
    event.recipes.gtceu.electric_blast_furnace("nijika:chemicals/barium/barite_reduction")
        .itemInputs(
            "4x #nijika:carbon_rich_dusts",
            "1x gtceu:barite_dust",
        )
    ...
    event.recipes.gtceu.chemical_reactor("nijika:chemicals/barium/barium_oxide_from_sulfide")
        .itemInputs(
            "2x gtceu:barium_sulfide_dust"
        )
        .inputFluids(Fluid.of("gtceu:oxygen").withAmount(6 * FluidAmounts.BUCKET))
        .itemOutputs(
            "2x gtceu:barium_oxide_dust"
        )
    ...
    // BaO + H2O = Ba(OH)2
    event.recipes.gtceu.mixer("nijika:chemicals/barium/barium_hydroxide")
