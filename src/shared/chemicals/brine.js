import { createAqueousIntermediate, createChemicalIntermediate, createDustIntermediate } from "../materials/helpers"

export const addBrineMaterials = (event) => {
    createAqueousIntermediate(event, "brine", 0x9da9b0);
    createChemicalIntermediate(event, "calcium_hydroxide", 0xc4afc2)
        .components("1x gtceu:calcium", "2x gtceu:oxygen", "2x gtceu:hydrogen");
}
...
export const addBrineRecipes = (event) => {
    event.recipes.gtceu.evaporation_pool("nijika:chemicals/brine/brine_evaporation")
    ...
    event.recipes.gtceu.chemical_reactor("nijika:chemicals/brine/potassium_chloride_extraction")
    ...
    event.recipes.gtceu.chemical_reactor("nijika:chemicals/misc/calcium_hydroxide")
    ...
    // TODO: Ammonia recipe?
    event.recipes.gtceu.chemical_reactor("nijika:chemicals/misc/calcium_hydroxide_neutralisation")
        .inputFluids(
